...
public class CartController {
    ...
    @PostMapping
    public CartItemResponse addToCart(@Valid @RequestBody AddToCartRequest request,@RequestParam Long userId){
    ...
    @PutMapping()
    public ResponseEntity<CartItemResponse> updateQuantity(@Valid @RequestBody AddToCartRequest request,@RequestParam Long userId){
        Product requestedProduct = productService.getProductById(request.getProductId());
        User user = userService.getUserById(userId);
    ...
    public ResponseEntity<Void> deleteItem(@PathVariable Long productId,@RequestParam Long userId){
